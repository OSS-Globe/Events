    ...
    <nav className="sticky top-0 z-50 w-full border-b border-surface-highlight bg-base/80 backdrop-blur-md">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Link 
            href="/contribute" 
            className="hidden md:inline-flex text-sm font-medium text-accent-blue hover:text-accent-blue/80 transition-colors"
          >
            Contribute
          </Link>
          <a 
            href="https://github.com/OSS-Globe/events" 
            target="_blank" 
